    ...
    return(
        <div className="preview-container mt-3">
          <div className="top-btn d-flex justify-content-end">
            ...
            <div  className="close-preview btn btn-outline-primary"><i className="me-1 fas fa-print"></i>Print</div>
          </div>
                ...
                <tbody>
                   <tr>
                    ...
                    <td>10:12:56</td>
                     ...
                     <td><i className='fas fa-check me-2'></i>Notified</td>
                   </tr>
                   <tr>
