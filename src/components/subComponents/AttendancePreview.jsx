    ...
    return (
        <div className="preview-container mt-3">
         <div className="top-btn d-flex justify-content-end">
            <div onClick={()=>setPreview(false)} className="close-preview btn btn-outline-danger mx-3"><i className="fas fa-eye-slash"></i></div>
            <div onClick={()=>print()} className="close-preview btn btn-outline-primary"><i className="me-1 fas fa-print"></i>Print</div>
          </div>
            <div className="preview-main">
                ...
                <div className="attendance-details py-5">
                    <div className="attendance-subject">
                        ...
                        <div className='attendance-details-text'>Fundamentals of Programming</div>
                    </div>
                    <div className="attendance-subject">
                    ...
                    <div className="attendance-subject">
                        ...
                        <div className='attendance-details-text'>{ Date().toString().slice(0,16)}</div>
                    </div>
                </div>
               ...
               <table className="campus-table table table-bordered">
                    <thead>
                        <tr>
                        <th className='fw-bold' scope="col">Course Code</th>
                        <th className='fw-bold' scope="col">Student Id</th>
