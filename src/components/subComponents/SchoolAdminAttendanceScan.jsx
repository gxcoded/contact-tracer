         ...
         <div className="staff-qr-scan-container">
             <div className="scanner-title d-flex justify-content-between align-items-center">
                 ...
                 <div className="scanner-title-text">
                     {
                         !scan ? 
                         <div onClick={(e)=>setScan(!scan)} className="toggler btn-sm btn-primary">Scan</div>
                         :
                         <div onClick={(e)=>setScan(!scan)} className="toggler btn-sm btn-danger"><i className="fas fa-times"></i></div>
                     }
                 ...
                 <div className="display-result">
                     ...
                     <div className="display-result-card border">
                         ...
                         <div className="card-bottom-btn p-2">
                             <div onClick={()=>saveScan()} className="btn btn-primary btn-block">Add</div>
                         </div>
                     </div>
                     }
                 </div>
            ...
            <div className="attendance-table-container">
                 ...
                 <div className="">
                   <div onClick={()=>saveData()} className="btn btn-primary"><i className="fas fa-save me-3"></i>Save</div>
                 </div>
             </div>
                 }
