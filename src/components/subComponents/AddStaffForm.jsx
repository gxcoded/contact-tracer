                ...
                <form action="" className="form-signUp mt-3">
                    <div className="form-inline d-flex ">
                        <div className="form-inline-left  d-flex justify-content-center">
                            <img src={Image} id='preview' onClick={trigger} className="image-preview" alt='img'/>
                            <input onChange={(e)=>previewImage(e)} id='picUploader' type="file" style={{display:'none'}}/>
                            <label onClick={trigger} className='mt-4'><i className='fas fa-upload me-3'></i>Upload Image</label>
                        </div>
                    ...
                    <div className="px-3 mt-5 d-flex justify-content-end">
                      <div onClick={()=>setShowForm(false)} className="btn btn-primary">Next
