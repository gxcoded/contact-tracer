    ...
    return(
        <div className='account-card'>
            <div className="account-card-upper-section">
                <img src={require(`../../assets/images/${img}`)} alt="img" className="account-card-img" />
            ...
            <img src={require(`../../assets/images/myqr.png`)} alt="img" className="account-card-qr-img" />
            <div className="card-qr-download-btn">
                <div onClick={()=>download()} className="btn btn-primary"><i className="fas fa-download me-1"></i>Download Qr Code</div>
            </div>
            </div>
        </div>
    )
