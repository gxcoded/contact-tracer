...
const SudoDashboard = ()=>{
    return(
        <div className="sudo-dashboard">
            <div className="sudo-dashboard-title"><i className="fas fa-table me-3"></i>Dashboard</div>
                ...
                <div className="dashboard-table-container p-4">
                    <table className="table table-striped">
                        <thead>
                            ...
                            <th className='fw-bold' scope="col">Data</th>
                            <th className='fw-bold' scope="col">Time Stamp</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
