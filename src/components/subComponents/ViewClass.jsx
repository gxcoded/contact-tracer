  ...
  return (
    <div className='view-class-container'>
        ...
        <div className="view-class-nav">
           <div onClick={(e)=>{setActive(e); setNewMeeting(true)}} className="view-class-nav-link nav-link-active">
           <i className="fas fa-grip-vertical me-2"></i>New Meeting
           </div>
           <div onClick={(e)=>{setActive(e);setMeetingLog(true)}} className="view-class-nav-link">
           <i className="fas fa-grip-vertical me-2"></i>Meetings
           </div>
           <div onClick={(e)=>{setActive(e);setStudents(true)}} className="view-class-nav-link">
