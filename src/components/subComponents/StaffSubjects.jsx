...
const StaffSubjects = ()=>{
    ...
    useEffect(()=>{
        const getList = async ()=>{
           ...
           const dataList = await fetchDataList('http://localhost:5000/records/yearList')
    ...
    return(
        <div className='staff-subject-container'>
            <div className="subject-header">
                ...
                {
                    !showAddForm ?
                <div onClick={()=>{setShowAddForm(!showAddForm)}} className="btn-sm btn-primary">Add Subject <i className="ms-1 fas fa-plus-circle"></i></div>:
                    ...
                    <form className="">
                        ...
                        <div className="subject-form">
                            <div className="form-group mt-3">
                                ...
                                <select onChange={(e)=>{updateSelections(e.target.value)}}  defaultValue={'0'} className='form-control'>
                    ...
                    <tbody>
                        ...
                        <td>
                            <div className="table-options">
                                    <span className='controls option-view text-warning'><i className="fas fa-pen"></i></span>
                                    <span className='controls option-delete'><i className="fas fa-trash-alt"></i></span>
                            </div>
                        </td>
                        </tr>
                    </tbody>
