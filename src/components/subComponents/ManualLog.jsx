        ...
        <div className="manual-log-main">
            <div className="manual-log-form">
                ...
                <div className="form-group">
                    ...
                    {
                        type === '2' &&
                    <select className='form-control' defaultValue={room} onChange={(e)=>setRoom(e.target.value)}>
            ...
            <div className="px-3 pt-5 text-end manual-save-btn">
                <div onClick={()=>addLog()} className="btn btn-success"><i className="me-3 far fa-save"></i>Save</div>
            </div>
        </div>
