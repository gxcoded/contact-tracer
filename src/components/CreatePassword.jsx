...
const CreatePassword = ()=>{
    ...
    const fetchUsername = async () =>{
        ...
        const response = await axios.post(`http://localhost:5000/ct-api/getUsername`,{
            hash
        })
    ...
    const registerAccount = async () =>{
        ...
        const response = await axios.post(`http://localhost:5000/ct-api/registerAccount`,{token,password})
        return await response.data
    }
               ...
               <div className="wrapper-background-right wrap-create">
                   ...
                   <div className="create-section">
                        <div className="display-section">
                            ...
                            <div className="create-text mt-4 text-center">Let's finish up setting your account. The username is provided by the system. Please create a password.</div>
                        </div>
                     <div className="form-section">
                      ...
                      <form onSubmit={submitCredentials} className='mt-3'>
                        <div className="form-group mt-3">
                            ...
                            <input type="text" className="form-control finalize" value={userName} readOnly/>
                        </div>
                        <div className="form-group mt-3">
                        ...
                        <div className="form-group mt-3">
                            ...
                            <input onChange={e=>setPassword2(e.target.value)} value={password2} required type="password" className="form-control " />
                        </div>
                        <div className="form-group mt-3">
                   ...
                   <div className="back-btn-section verify-bck-btn">
                                 <p><Link to='/signOptions'><i className="fas fa-arrow-left me-2"></i>Go Back</Link></p>
                            </div>
               </div>
